#!/bin/bash
# ==============================================================================
# 🛡️ NetGuard Pro v5.3 (GitHub Edition)
# One-liner compatible installation script for any Debian-based Linux Desktop.
# ==============================================================================
set -e
...
echo -e "${CYAN}${BOLD}🛡️ Starting NetGuard Pro v5.3 Universal Installation...${RESET}"

# 1. Desktop Environment & Dependency Audit
DE=$XDG_CURRENT_DESKTOP
echo -e "📦 Detecting Environment: ${BOLD}$DE${RESET}"
...
# Ensure UFW is active for blocking
ufw --force enable

# 2. Setup System Paths & Threat Intelligence
...
# 5. Install the Scanner Engine (UFW + Bandwidth)
...
echo -e "\n${GREEN}${BOLD}✅ SUCCESS: NetGuard Pro v5.3 Installed!${RESET}"
echo -e "🚀 Run '${BOLD}netguard-dash${RESET}' to view the visual console."
echo -e "🚀 The tray applet will launch on next login (or run manually now)."
